   ...
   // x = 280 * 100 / 240
    ...
    $(".boxhome").hover(
      function () {
        ...
        $(this).stop().animate({'width': 400, 'height': (nekikur+50), 'font-size' : 25}, {duration:300});
        ...
        $(".boxhome").not(this).stop().animate({'width': 355, 'height':nekikur}, {duration:250});
      }, 
      function () {
        
        $(this).stop().animate({'width': 370, 'height':nekikur}, {duration:300});
    ...
    //   $('.inactiveBH h1').stop().animate({fontSize: '30px'}, {duration:250});
      ...
      //  $('.inactiveBH p').stop().animate({fontSize: '14px'}, {duration:250});
        ...
        $(".boxhome").not(this).stop().animate({'width': 367, 'height':nekikur}, {duration:250});
...
/*
     FILE ARCHIVED ON 01:06:35 Mar 20, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 07:05:38 Aug 31, 2024.
...
playback timings (ms):
  ...
  esindex: 0.015
  cdx.remote: 15.78
  LoadShardBlock: 37.857 (3)
  PetaboxLoader3.datanode: 77.719 (5)
  load_resource: 258.614 (2)
  PetaboxLoader3.resolve: 97.323 (2)
*/